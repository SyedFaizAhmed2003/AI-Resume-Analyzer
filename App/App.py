...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="" style="text-decoration: none; color: #021659;">Syed Faiz Ahmed</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="" style="text-decoration: none; color: grey;">Syed Faiz Ahmed</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Syed Faiz Ahmed ! Total %d " % values + " User's Have Used Our Tool : )")                
